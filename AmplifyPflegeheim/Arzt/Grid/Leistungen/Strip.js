...
class CalendarStrip extends Component {
      ...
      <View style={styles.header}>
        ...
        {!this.state.isTodayVisible &&
          <TouchableOpacity style={styles.headerGoTodayButton} onPress={() => {
            ...
            onPressGoToday && onPressGoToday(selectedDate);
            this.scrollToPage(page);
          }}>
            <Text style={styles.todayText}>Z</Text>
          </TouchableOpacity>
        }
      </View>
    );
  ...
  _renderBody= () => {
    ...
    return (
      <View>
          <TouchableSwipe
                  config={{tapThreshold: 70}}
                  onPress={() => console.warn('You Pressed')}
                  onSwipeLeft={() => console.warn('You Swiped Left')}
                  onSwipeRight={() => console.warn('You Swiped Right')}>
